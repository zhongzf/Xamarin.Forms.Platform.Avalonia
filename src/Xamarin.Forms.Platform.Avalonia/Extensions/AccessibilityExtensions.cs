...
{
	public partial struct AccessibilityView
	{
	}

	public static class AccessibilityExtensions
	{
		public static void SetAutomationPropertiesAutomationId(this Control Control, string id)
		{
			//Control.SetValue(NativeAutomationProperties.AutomationIdProperty, id);
		}

		public static string SetAutomationPropertiesName(this Control Control, Element Element, string _defaultAutomationPropertiesName = null)
		{
			if (Element == null)
		...
		public static AccessibilityView? SetAutomationPropertiesAccessibilityView(this Control Control, Element Element, AccessibilityView? _defaultAutomationPropertiesAccessibilityView = null)
		{
			if (Element == null)
		...
		public static string SetAutomationPropertiesHelpText(this Control Control, Element Element, string _defaultAutomationPropertiesHelpText = null)
		{
			if (Element == null)
		...
		public static InputElement SetAutomationPropertiesLabeledBy(this Control Control, Element Element, InputElement _defaultAutomationPropertiesLabeledBy = null)
		{
			if (Element == null)
