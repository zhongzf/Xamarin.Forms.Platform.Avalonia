...
namespace Xamarin.Forms.Platform.Avalonia
{
	public class ButtonRenderer : ViewRenderer<Button, FormsButton>
	{
		...
		protected virtual bool PreventGestureBubbling { get; set; } = true;
		...
		{
			Control.BorderThickness = Element.BorderWidth == (double)Button.BorderWidthProperty.DefaultValue ? new global::Avalonia.Thickness(3) : new global::Avalonia.Thickness(Element.BorderWidth);
		}
		...
		static StackPanel CreateContentContainer(Button.ButtonContentLayout layout, global::Avalonia.Controls.Image image, string text)
		{
