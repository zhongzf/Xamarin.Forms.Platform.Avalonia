...
namespace Xamarin.Forms.Platform.Avalonia.Experiments
{
        ...
        ITitleViewProvider, IToolbarProvider, IToolBarForegroundBinder
    {
        ...
        public void SetElement(VisualElement element)
        {
            ...
            if (element != null)
            {
                if (_container == null)
                {
                    ...
                    Tracker = new BackgroundTracker<PageControl>(TemplatedControl.BackgroundProperty) { Element = (Page)element, Container = _container };
        ...
        {
            Element.ContainerArea = new Rectangle(0, 0, double.IsNaN(_container.ContentWidth) ? _container.Bounds.Width : _container.ContentWidth, double.IsNaN(_container.ContentHeight) ? _container.Bounds.Height : _container.ContentHeight);
        }
        ...
        async void UpdateTitleIcon()
        {
            ...
            _titleIcon = await source.ToNativeImageSourceAsync();
        ...
        public void BindForegroundColor(CommandBar appBar)
        {
        ...
        void SetAppBarForegroundBinding(Control element)
        {
        ...
        void UpdateToolbarPlacement()
        {
            ...
            _container.ToolbarPlacement = (AvaloniaForms.ToolbarPlacement)Element.OnThisPlatform().GetToolbarPlacement();
        }
