...
namespace Xamarin.Forms.Platform.Avalonia.Interfaces
{
    ...
    public class DefaultNavigation : IFormsNavigation
    {
        public FormsWindow ParentWindow
        {
            get
            {
                if ((global::Avalonia.Application.Current as IClassicDesktopStyleApplicationLifetime)?.MainWindow is FormsWindow)
                {
                    return (global::Avalonia.Application.Current as IClassicDesktopStyleApplicationLifetime)?.MainWindow as FormsWindow;
                }
                return null;
            }
        }
