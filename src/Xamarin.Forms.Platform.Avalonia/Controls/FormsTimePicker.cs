...
namespace Xamarin.Forms.Platform.Avalonia.Controls
{
    public class FormsTimePicker : TextBox, IStyleable
    {
        ...
        {
            TimeProperty.Changed.AddClassHandler<FormsTimePicker>((x, e) => x.OnTimePropertyChanged(e));
            TimeFormatProperty.Changed.AddClassHandler<FormsTimePicker>((x, e) => x.OnTimeFormatPropertyChanged(e));
        }
